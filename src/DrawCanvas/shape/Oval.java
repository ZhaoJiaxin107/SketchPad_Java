...
public class Oval extends Shape{
	...
	private static boolean pointInOval(Point p, int left, int top, int width,int height) {
	...
	public boolean containsPoint(Point p) {
		return pointInOval(p,begin.x, begin.y, dragPoint.x-begin.x, dragPoint.y-begin.y);
	}
